...
async fn send_saved(sock: &mut TcpSocket<'_>, ssid: &str) {
    ...
    const A: &str = "<!doctype html><html><head><meta charset=utf-8><meta name=viewport content=\"width=device-width,initial-scale=1\"><title>Saved</title><style>body{font-family:system-ui,sans-serif;background:#12142b;color:#f4ebd0;margin:0}.w{max-width:420px;margin:0 auto;padding:24px}h1{color:#f2b84b}p{color:#8e93b4}</style></head><body><div class=w><h1>Saved</h1><p>Hoot is now connecting to <b>";
